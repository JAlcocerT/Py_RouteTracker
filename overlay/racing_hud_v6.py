...
# --- 1. CONFIGURATION ---
VIDEO_PATH = "/home/jalcocert/Desktop/Py_RouteTracker/Z_GoPro/GX020410.MP4"
...
if __name__ == "__main__":
    ...
    # 4. Laps
    df_final, laps = detect_laps(df_merged)
    print(f"Found {len(laps)} Laps.")
    
    # 5. Render
    out = render_hud_v6(df_final, laps)
    print(f"DONE: {out}")
